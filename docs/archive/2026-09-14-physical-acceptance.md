...
Harley operated the real camera and reported completion. No synthetic camera input was used. Browser accessibility observations confirmed:

- Test nickname: `TEST-Harley-0914` (intentional production test data).
...
Harley reported: “didnt feel that accurate. after a miss, it still feel slow and unclear until the next move”. This run is not an acceptance pass. The most concrete obstacle is the wait and unclear state after a miss; perceived control accuracy remains unresolved.
