...
try {
  ...
  for (const suite of ['dual-hand-controls', 'grab-release', 'hand-menu', 'arcade-presentation', 'audio', 'movement-music', 'camera', 'gesture-feedback', 'arcade', 'carousel', 'contact', 'delivery-clearance']) {
