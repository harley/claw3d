...
export const PHASES = { anticipate: .20, descend: .85, grip: 1.05, lift: 1.8, transfer: 2, release: .55, deliver: 3.8, reveal: 1.3 };
...
export const ASSORTMENT = [
  ...
  { id: 'peach', family: 'star', name: 'Peach', color: '#f5ac84', tone: 'Peach soda · squishy jelly', x: -.10, z: .06, yaw: .17, scale: 1 },
  { id: 'cocoa', family: 'capybara', name: 'Cocoa', color: '#90684f', tone: 'Cocoa · sleepy plush', x: .57, z: .06, yaw: .30, scale: .94 },
  { id: 'sprout', family: 'star', name: 'Sprout', color: '#b6d770', tone: 'Lime fizz · squishy jelly', x: 1.16, z: .56, yaw: -.33, scale: .85 },
