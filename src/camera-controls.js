...
export async function createCameraControls({ video, overlay, select, onChange, canControl, onDrop, onGesture, getControlProfile, getControlTarget, maxHands = 1, holdMs }) {
  ...
  const controller = new HandController({ video, overlay, select, maxHands, holdMs,
