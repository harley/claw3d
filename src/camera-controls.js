...
export async function createCameraControls({ video, overlay, select, onChange, canControl, onDrop, onGesture, getControlProfile, canGrab }) {
  ...
  const controller = new HandController({ video, overlay, select,
    ...
    onGesture, getControlProfile, canGrab,
